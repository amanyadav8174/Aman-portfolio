...
const DotMatrix: React.FC<DotMatrixProps> = ({
  ...
  const uniforms = useMemo(() => {
    ...
    return {
      ...
      u_resolution: {
        value: [window.innerWidth, window.innerHeight], // Use an array for resolution
        type: "uniform2fv", // Use uniform2fv for a 2D vector
      },
    };
  }, [colors, opacities, totalSize, dotSize]);
...
const ShaderMaterial = ({
  ...
  const getUniforms = () => {
    ...
    preparedUniforms["u_time"] = { value: 0, type: "1f" };
    preparedUniforms["u_resolution"] = {
      value: [size.width, size.height], // Use array for resolution
      type: "uniform2fv", // Use uniform2fv type
    };
    return preparedUniforms;
  };
